      ...
      <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-200">
        ...
        {status === 'pending' && (
          <>
            ...
            <button onClick={() => navigate('/my-orders')} className="px-6 py-3 bg-brand text-white font-bold rounded-xl hover:bg-brand-fonce transition-colors">
              Voir mes commandes
            </button>
          </>
        )}
        ...
        {status === 'failed' && (
          <>
            ...
            <button onClick={() => navigate('/cart')} className="px-6 py-3 bg-brand text-white font-bold rounded-xl hover:bg-brand-fonce transition-colors">
              Retour au panier
            </button>
          </>
        )}
