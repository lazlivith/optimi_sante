    ...
    <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          onClick={analyse}
          disabled={busy || !file}
          className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-brand text-white text-sm font-medium hover:bg-brand-fonce disabled:opacity-40 ml-auto"
        >
        ...
        <div className="space-y-3 border-t border-slate-100 pt-4">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            {onApply && (
              <button
                onClick={apply}
                className="px-4 py-2 rounded-lg bg-brand text-white text-sm font-medium hover:bg-brand-fonce"
              >
                Valider et reporter
              </button>
            )}
